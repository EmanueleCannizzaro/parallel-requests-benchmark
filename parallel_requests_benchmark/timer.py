...
def timer(number, repeat, name=''):
    def wrapper(func):
        def inner(*args, **kwargs):
            ...
            message = "The execution time for a single run and the total runs of \033[32m{name:^40}\033[0m are \033[32m{average_single_runtime:>20.6f}\033[0m and \033[32m{average_runtime:>20.6f}\033[0m."
